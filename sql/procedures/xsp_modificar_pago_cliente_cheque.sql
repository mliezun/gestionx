DROP PROCEDURE IF EXISTS `xsp_modificar_pago_cliente_cheque`;
DELIMITER $$
CREATE PROCEDURE `xsp_modificar_pago_cliente_cheque`(pToken varchar(500), pIdPago bigint,
pFechaDebe datetime, pFechaPago datetime, pIdCheque bigint, pObservacionesPago text,
pIP varchar(40), pUserAgent varchar(255), pAplicacion varchar(50))
SALIR:BEGIN
	/*
    * Permite modificar un pago de un cliente, utilizando un cheque.
    ...
    */
	...
	END;
    -- Controla Parámetros
    CALL xsp_puede_ejecutar(pToken, 'xsp_modificar_pago_cliente_cheque', pMensaje, pIdUsuario);
    IF pMensaje != 'OK' THEN 
