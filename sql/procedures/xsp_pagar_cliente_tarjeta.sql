DROP PROCEDURE IF EXISTS `xsp_pagar_cliente_tarjeta`;
DELIMITER $$
CREATE PROCEDURE `xsp_pagar_cliente_tarjeta`(pToken varchar(500), pIdCliente bigint, pIdMedioPago smallint,
...
SALIR:BEGIN
	/*
    * Permite dar de alta un nuevo pago de un cliente, utilizando una tarjeta.
    ...
    */
	...
	END;
    -- Controla Parámetros
    CALL xsp_puede_ejecutar(pToken, 'xsp_pagar_cliente_tarjeta', pMensaje, pIdUsuario);
    IF pMensaje != 'OK' THEN 
