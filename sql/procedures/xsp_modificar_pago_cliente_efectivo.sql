DROP PROCEDURE IF EXISTS `xsp_modificar_pago_cliente_efectivo`;
DELIMITER $$
CREATE PROCEDURE `xsp_modificar_pago_cliente_efectivo`(pToken varchar(500), pIdPago bigint, pMontoPago decimal(12,2),
pFechaDebe datetime, pFechaPago datetime, pObservacionesPago text,
pIP varchar(40), pUserAgent varchar(255), pAplicacion varchar(50))
SALIR:BEGIN
	/*
    * Permite modificar un pago de un cliente, utilizando un efectivo.
    ...
    */
	...
	END;
    -- Controla Parámetros
    CALL xsp_puede_ejecutar(pToken, 'xsp_modificar_pago_cliente_efectivo', pMensaje, pIdUsuario);
    IF pMensaje != 'OK' THEN 
