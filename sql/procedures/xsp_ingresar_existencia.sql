DROP PROCEDURE IF EXISTS `xsp_ingresar_existencia`;
DELIMITER $$
CREATE PROCEDURE `xsp_ingresar_existencia`(pIdUsuario bigint, pIdIngreso bigint, pIP varchar(40), pUserAgent varchar(255), pAplicacion varchar(50), out pMensaje text)
SALIR: BEGIN
    /*
	Permite ingresar una existencia, controlando que tenga al menos una línea.
	...
	*/
    ...
    UPDATE Ingresos SET Estado = 'I' WHERE IdIngreso = pIdIngreso;
