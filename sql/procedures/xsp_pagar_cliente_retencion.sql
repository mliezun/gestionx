DROP PROCEDURE IF EXISTS `xsp_pagar_cliente_retencion`;
DELIMITER $$
CREATE PROCEDURE `xsp_pagar_cliente_retencion`(pToken varchar(500), pIdCliente bigint, pIdMedioPago smallint,
...
SALIR:BEGIN
	/*
    * Permite dar de alta un nuevo pago de un cliente, utilizando efectivo a un agente de Retencion.
    ...
    */
	...
	END;
    -- Controla Parámetros
    CALL xsp_puede_ejecutar(pToken, 'xsp_pagar_cliente_retencion', pMensaje, pIdUsuario);
    IF pMensaje != 'OK' THEN 
