DROP PROCEDURE IF EXISTS `xsp_modificar_pago_cliente_tarjeta`;
DELIMITER $$
CREATE PROCEDURE `xsp_modificar_pago_cliente_tarjeta`(pToken varchar(500), pIdPago bigint, pMontoPago decimal(12,2),
...
SALIR:BEGIN
	/*
    * Permite modificar un pago de un cliente, utilizando una tarjeta.
    ...
    */
	...
	END;
    -- Controla Parámetros
    CALL xsp_puede_ejecutar(pToken, 'xsp_modificar_pago_cliente_tarjeta', pMensaje, pIdUsuario);
    IF pMensaje != 'OK' THEN 
